...
import com.cts.conctes.exception.ConstructionEstimationException; public class DBConnectionManager {
...
Properties properties=new Properties(); FileReader f=null;
try {
...
String user=properties.getProperty("username"); String password=properties.getProperty("password"); try {
